Setting up a small project in SOILE
===================================
...
The guide assumes that you have a user account, that your user account has the Researcher role and that you are logged in.
In this guide we will show you how to set up a simple Project, containing most features of SOILE.

The quickstart consists of the following steps:
