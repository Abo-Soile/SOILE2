...
.. image:: /_static/images/quickstart/study/setup.png
  :alt: Study setup screen

You have to give the study a Name and a Description and, most importantly select a Project at a specific version that this study will run. 
NOTE: Even if the project gets deleted from the UI, the study will still run and the data correct Project will still be used.
...
Once a study is activated and has participants, the Project and project version cannot be changed. 
